    ...
    <CardBox>
      <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        ...
        <div className="flex flex-wrap items-end gap-3">
          <label><span className="mb-1 block text-xs text-darklink">Start date</span><input type="date" value={startDate} onChange={(event) => setStartDate(event.target.value)} className="rounded-md border border-ld bg-transparent px-3 py-2" /></label>
          <label><span className="mb-1 block text-xs text-darklink">End date</span><input type="date" value={endDate} onChange={(event) => setEndDate(event.target.value)} className="rounded-md border border-ld bg-transparent px-3 py-2" /></label>
